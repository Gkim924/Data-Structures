...
```
Original: sheet.render() == expected
Expanded: PNG(w=900, h=600, hash=40610eb82d8009f2)
==
PNG(w=900, h=600, hash=7fba8083f2e0faa4)
```
...
```
Original: sheet.render() == expected
Expanded: PNG(w=900, h=600, hash=3fa48f43ec5ef17d)
==
...
This report was generated for **gk10** using **cf25f6b25af818dbd49b96882cb0cc792f65f664** (from **February 12th 2019, 12:05:00 am**)
